...
import com.ignition.flow.SelectAction.{ Remove, Rename, Retain, Retype }
import com.ignition.types._

@RunWith(classOf[JUnitRunner])
class SelectValuesSpec extends FlowSpecification {
  import com.ignition.flow.SelectAction._
