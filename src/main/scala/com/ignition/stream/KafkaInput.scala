 ...
 */
case class KafkaInput(brokers: Iterable[String], topics: Iterable[String], field: String = "payload") extends StreamProducer {
  ...
  private val kafkaParams = Map("metadata.broker.list" -> brokers.mkString(","))
